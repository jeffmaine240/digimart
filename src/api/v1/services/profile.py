...
from src.api.v1.models import User, Profile
...
from src.api.utils.cloudinary_config import cloudinary
...
class ProfileService:
    def check_profile_exist_with_user_id(self, user_uuid: str, db: Session)-> bool:
        """
    ...
    def create_profile(self, db: Session, profile_data: CreateUserProfile, current_user_uuid)-> Profile:
